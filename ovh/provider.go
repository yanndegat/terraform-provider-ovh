...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ovh_clouddb_enterprise":               dataSourceCloudDBEnterprise(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ovh_enterprise_cloud_db_security_group":                      resourceEnterpriseCloudDBSecurityGroup(),
			"ovh_enterprise_cloud_db_security_group_rule":                 resourceEnterpriseCloudDBSecurityGroupRule(),
			"ovh_clouddb_enterprise_security_group":                       resourceCloudDBEnterpriseSecurityGroup(),
			"ovh_clouddb_enterprise_security_group_rule":                  resourceCloudDBEnterpriseSecurityGroupRule(),
