...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ovh_clouddb_enterprise_cluster":       dataSourceCloudDBEnterpriseCluster(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ovh_clouddb_enterprise_cluster_security_group":               resourceCloudDBEnterpriseClusterSecurityGroup(),
			"ovh_clouddb_enterprise_cluster_security_group_rule":          resourceCloudDBEnterpriseClusterSecurityGroupRule(),
